...
export const Login = () => {
  return (
    <div className=" flex flex-col w-[578px] h-[770px] bg-white mt-14 rounded-3xl mb-[150px]">
      <div className=" flex flex-col items-center text-center mt-6 gap-4">
        <div>
          <Image src={Logo} alt="Logo" style={{ objectFit: "cover" }} />
        </div>

        <div className="text-2xl text-[#C19102] font-bold">Login</div>
      </div>
      ...
      <div className="flex flex-col items-center mt-10 gap-4">
        ...
        <div className="">
          ...
          <Button
            variant={"link"}
            className="text-xs text-[#979797] ml-[-5px] mt-[-8px]"
          >
            Forget Password?
          </Button>
        </div>
        <div className="flex flex-col items-center mb-20">
          <Button className="text-center bg-[#FFC107] rounded-2xl text-black w-[150px] h-[50px]">
            Login
          </Button>
          ...
          <Link href={"/auth/signup"} className="font-medium mt-[35px]">
